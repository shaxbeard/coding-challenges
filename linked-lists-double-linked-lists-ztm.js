...
class DoublyLinkedList {
    ...
    append(value) {
        ...
        newNode.prev = this.tail; // Set the value of the prev pointer to the node that WAS the tail
    ...
    prepend(value) {
        ...
        newNode.next = this.head // Make a next pointer from the new node to the old head
        this.head.prev = newNode; // Make a prev pointer from the old head to the new node
